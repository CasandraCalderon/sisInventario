                                      ...
                                      while ($fila=$bd->mostrar_registros()) { ?>
                                        ...
                                        <?php $id= $fila->id_service; ?>
                                             ...
                                             <?php
                                              ...
                                              mysql_select_db("pagos",$conexion);
                                              ?>
                                             <?php
                                               $suma="SELECT SUM(cantida_movimiento) FROM ingresos WHERE id_service_id_ingreso = '$id'";
                                               $resultado=mysql_query($suma,$conexion);
                                               
                                               
                                               ?>
                                               <td  width="25%"><?php echo mysql_result($resultado, 0);?></td>
                                               <?php
                                               $suma="SELECT SUM(cantida_salida) FROM salida WHERE id_service_id_salida = '$id'";
                                               $resultado=mysql_query($suma,$conexion);
                                               ?>
                                               <td  width="25%"><?php echo mysql_result($resultado, 0);?></td>
