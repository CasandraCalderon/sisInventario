               ...
               $.ajax({
                  ...
                  }).done(function(json) 
                      {
                          json = $.parseJSON(json)
                              ...
                              {
                                  $('.editinplace3').html(
                                    "<div class='col-xs-6'><table class='editinplace3 table table-striped table-hover'><tr><td width='20%'><span class='text-success'></span><span style='color: #acacac; font-size: 9pt; text-align: left;'>ID: &nbsp; </td><td class='id'width='80%' >"+json[i].id_proveedor+" </span></td></tr> <tr><td width='20%' ><span class='text-success'></span><span style='color: #acacac; font-size: 9pt; text-align: left;'>Cedula de identidad:</span></td><td class='editable' data-campo='ci_proveedor' width='80%' ><span><a class='link'>"+json[i].ci_proveedor+"</a></span></td></tr> <tr><td width='20%' ><span class='text-success'></span><span style='color: #acacac; font-size: 9pt; text-align: left;'>Nombre:</span></td><td class='editable' data-campo='item' width='80%' ><span><a class='link'>"+json[i].nombre_proveedor+"</a></span></td></tr> <tr><td width='20%' ><span class='text-success'></span><span style='color: #acacac; font-size: 9pt; text-align: left;'>Unidad:</span></td><td class='editable' data-campo='telefono_proveedor' width='80%' ><span><a class='link'>"+json[i].telefono_proveedor+"</a></span></td></tr><tr><td width='20%' ><span class='text-success'></span><span style='color: #acacac; font-size: 9pt; text-align: left;'>Correo:</span></td><td class='editable' data-campo='correo' width='80%' ><span><a class='link'>"+json[i].correo+"</a></span></td></tr></div></div>");
                              }   
                              }   
