        ...
        if (isset($_GET['eliminar'])) { 
                ...
                if( $x1=="" ){
                    ...
                    echo "<br>";
                                ...
                                $sql2="SELECT * FROM `ingresos` WHERE `ingresos`.`id_ingreso`='".$x1."'";
                                $bd->consulta($sql2);
                                while ($fila=$bd->mostrar_registros()) {
                                  $idn= $fila->id_service_id_ingreso; 
                                  $total= $fila->cantida_movimiento; 
                                 }
                                 $sql3="UPDATE `service` SET `service`.`cantida`=`service`.`cantida`-'$total' WHERE `service`.`id_service`='$idn'";
                                 $bd->consulta($sql3);
                                $sql4="delete from `ingresos` where `ingresos`.`id_ingreso`='".$x1."'";
                                $bd->consulta($sql4);
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          <a style=" margin-left: 10px;"  title="Registrar Nuevo" class="btn green btn-outline sbold " data-toggle="modal" href="#productoguarda">Nueva Entrada </a> 
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="min-phone-l">Material</th>
                                                <th class="min-phone-l">Responsable</th>
